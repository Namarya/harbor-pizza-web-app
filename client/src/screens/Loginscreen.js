  ...
  return (
    <div style={{marginTop: "4rem"}}>
      <div className="d-flex justify-content-center text-start mb-5">
        <div className="mt-5 p-5 rounded" style={{ backgroundColor: "white", width: "50rem"}}>
          ...
          <input type="email" placeholder="email" className="form-control" value={email} required onChange = {(e)=>{setemail(e.target.value)}} />
            ...
            <div className="d-flex mt-3 align-items-center">
              <button className="btn me-3" onClick={login}>LOGIN</button>
              <a href="/register" style={{color:"black"}} className="link">Click here to register</a>
            </div>
          </div>
        </div>
      </div>
